...
public class EtapaServicoController {
	...
	public ResponseEntity<EtapaServicoResDTO> criar(@RequestBody @Valid EtapaServicoReqDTO dto, @PathVariable(required=true) Long idTipoServico) {
	...
	public ResponseEntity<EtapaServicoResDTO >atualizar(@RequestBody @Valid EtapaServicoReqDTO dto, @PathVariable(required=true) Long idEtapaServico) {
	...
	public ResponseEntity<EtapaServicoResDTO> atualizarOrdem(@RequestBody @Valid OrdemDTO dto, @PathVariable Long idEtapaServico){
